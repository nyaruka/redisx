...
func (l *Locker) Grab(ctx context.Context, client valkey.Client, retry time.Duration) (string, error) {
...
func (l *Locker) Release(ctx context.Context, client valkey.Client, value string) error {
...
func (l *Locker) Extend(ctx context.Context, client valkey.Client, value string, expiration time.Duration) error {
...
func (l *Locker) IsLocked(ctx context.Context, client valkey.Client) (bool, error) {
